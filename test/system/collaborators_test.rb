...
class CollaboratorsTest < ApplicationSystemTestCase
  ...
  test "creating a Collaborator" do
    ...
    fill_in "Percentage profit", with: @collaborator.percentage_profit
    fill_in "Phone number", with: @collaborator.phone_number
    fill_in "Profit amount", with: @collaborator.profit_amount
